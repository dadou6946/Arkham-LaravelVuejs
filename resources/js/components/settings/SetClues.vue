                ...
                <div id="modal1" class="modal open" tabindex="0" style="z-index: 999; display: block; opacity: 1; top: 10%; transform: scaleX(1) scaleY(1);height:168px;">
                    <div class="modal-content">
                        ...
                        <div class="right-align">
                            <a href="#!" class="modal-close waves-effect waves-light btn teal" @click="continueAction">Etape suivante</a>
                        </div>
                    </div>
                </div>
        </body>
        ...
        data: function(){
            return {
                ...
                sites: [
                    ...
                    { name: "L'ile<br>rinexplorée10"             , id: "10", type: "site", character: [],                 monster: [], event: [], clue: 1, color: "green",  portal: [], marker: []},
