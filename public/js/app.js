          ...
          _vm._l(_vm.anciens, function(ancien) {
            return _c(
              "button",
              {
                staticClass: "btn",
                class: {
                  "btn-light": !ancien.selected,
                  "btn-success": ancien.selected
                },
                on: {
                  click: function($event) {
                    ...
                    _vm._l(investigator.object, function(ob) {
                      return _c("li", [
                        ...
                        _c("div", {
                          ...
                          domProps: { innerHTML: _vm._s(ob) }
                        }),
                        _vm._v(" "),
                        _c("img", {
                          attrs: { src: "Lance-Flammes.jpg", alt: "" }
                        })
                      ])
                    })
                  ),
                  ...
                  _c(
                    ...
                    _vm._l(investigator.object, function(ob) {
                      return _c("li", [
                        ...
                        _c("img", {
                          attrs: {
                            src: "/image/card/common/Lance-Flammes.jpg",
                            alt: ""
                          }
                        })
                      ])
